...
namespace Service.Contracts
{
    public interface ICandidateService
    {
        ...
        Task<CandidateDto> UpdateCandidateForPollAsync(Guid userId, Guid pollId, Guid id, CandidateForUpdateDto candidateForUpdate, bool pollTrackChanges, bool candTrackChanges);
    }
}
